...
public class Virus{
	public static String diagnose(String symptom, String contact) {
		if (symptom.equals("发热") || symptom.equals("咽喉痛") || symptom.equals("咳嗽") || symptom.equals("鼻塞") || symptom.equals("流鼻涕") 
				|| symptom.equals("胸闷") || symptom.equals("气急") || symptom.equals("呼吸困难") 
				|| symptom.equals("全身酸痛") || symptom.equals("乏力") || symptom.equals("腹泻")) {
			if (contact.equals("有武汉（湖北）等疫区旅游史或居住史") || contact.equals("有接触过来自武汉（湖北）、温州、台州的人员") 
					|| contact.equals ("有接触过疑似或确诊新型冠状病毒感染者") || contact.equals ("身边有多人出现发热、乏力、咳嗽、咽痛等")) {
